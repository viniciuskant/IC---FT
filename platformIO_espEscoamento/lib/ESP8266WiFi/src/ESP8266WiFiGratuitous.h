...
class ESP8266WiFiGratuitous
{
  public:
    ...
    // A gratuitous ARP packet is immediately sent when calling this function,
    // then based on a time interval in milliseconds, default = 1s return value:
    ...
    static void stationKeepAliveStop()
    {
        (void)stationKeepAliveSetIntervalMs(0);
    }
