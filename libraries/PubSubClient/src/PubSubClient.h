...
class PubSubClient : public Print
{
  ...
  public:
    ...
    PubSubClient(const char *, uint16_t, MQTT_CALLBACK_SIGNATURE,
                 Client &client);
    PubSubClient(const char *, uint16_t, MQTT_CALLBACK_SIGNATURE,
    ...
    //   endPublish()
    // Allows for arbitrarily large payloads to be sent without them having to
    // be copied into a new buffer and held in memory at one time Returns 1 if
    // the message was started successfully, 0 if there was an error
